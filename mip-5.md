...
**TLDR: The Metaplex Foundation will implement the following procedure for MIPs for the Metaplex Program Library on an ongoing basis:**
...
If a Community MIP submission is legitimate (i.e., not spam, not made in bad faith) then Metaplex Foundation will refund the 10 USDC payment to the Original Proposer. We reuqire a 10 USDC payment for each submission to prevent being spammed. We are open to changing the submission requirements to find the right balance to prevent spam but also not discourage legitimate submissions and encourage community process prospoals. 
...
A summary of the feedback from the “Community Feedback Period” will be added to the proposal after the 14-day period.
...
No - The process shall be the same for all potential topics covered by the MIP process (extending or modifying the Metaplex Protocol). However, the process for Metaplex Treasury Proposals ("MTPS") and Metaplex Process Proposals ("MPPs") is different. 
